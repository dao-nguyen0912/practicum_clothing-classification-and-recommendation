...
cb_checkpointer = ModelCheckpoint(filepath = 'DAO/output/TB_resnet50_sgd.hdf5', monitor = 'val_loss', save_best_only = True, mode = 'auto')
...
base_model = ResNet50(input_shape = (150, 150, 3), # Shape of our images
...
model.load_weights('DAO/output/TB_resnet50_sgd.hdf5')
model.save('DAO/output/TB_resnet50_sgd.h5')