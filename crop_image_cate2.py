...
df_cate2_concat =pd.read_csv('DAO/df_22categories_42775_v2.csv')
...
y_train =X_train_filename.loc[:,['img_cate2_name']]
y_val =X_test_filename.loc[:,['img_cate2_name']]
...
os.mkdir('DATA/DeepFashion_crop_cate2/')
os.mkdir('DATA/DeepFashion_crop_cate2/img')
os.mkdir('DATA/DeepFashion_crop_cate2/img/train')
os.mkdir('DATA/DeepFashion_crop_cate2/img/val')
...
#    list_img.append([Filter_dftrain.index[i],f_image])
    ...
    if not os.path.exists('DATA/DeepFashion_crop_cate2/img/train/' + foldercheck):
      os.mkdir('DATA/DeepFashion_crop_cate2/img/train/' + foldercheck)
    if not os.path.exists('DATA/DeepFashion_crop_cate2/img/train/' + foldercheck+'/'+foldercheck1):
      os.mkdir('DATA/DeepFashion_crop_cate2/img/train/' + foldercheck+'/'+ foldercheck1)
    f_image.save('DATA/DeepFashion_crop_cate2/img/train/'+Filter_dftrain.index[i])
...
#    list_img.append([Filter_dfval.index[i],f_image])
    ...
    if not os.path.exists('DATA/DeepFashion_crop_cate2/img/val/' + foldercheck):
      os.mkdir('DATA/DeepFashion_crop_cate2/img/val/' + foldercheck)
    if not os.path.exists('DATA/DeepFashion_crop_cate2/img/val/' + foldercheck+'/'+foldercheck1):
      os.mkdir('DATA/DeepFashion_crop_cate2/img/val/' + foldercheck+'/'+ foldercheck1)
    f_image.save('DATA/DeepFashion_crop_cate2/img/val/'+Filter_dfval.index[i])
print('Finish')