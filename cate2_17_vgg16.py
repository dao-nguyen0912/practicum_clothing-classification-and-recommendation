...
early_stopper = EarlyStopping(monitor='val_loss',
                              patience=30,
                              verbose=1)
checkpoint = ModelCheckpoint('DAO/output/model_17cate2_VGG16.hdf5')
def custom_generator(iterator):
    while True:
        batch_x, batch_y = iterator.next()
        yield (batch_x, batch_y)

model.load_weights('DAO/output/model_17cate2_VGG16.hdf5')
model.fit(custom_generator(train_iterator),
...
model.load_weights('DAO/output/model_17cate2_VGG16.hdf5')
model.save('DAO/output/model_17cate2_VGG16.h5')