...
cb_checkpointer = ModelCheckpoint(filepath = 'DAO/output/TB_vgg16_sgd.hdf5', monitor = 'val_loss', save_best_only = True, mode = 'auto')
...
model.load_weights('DAO/output/TB_vgg16_sgd.hdf5')
model.save('DAO/output/TB_vgg16_sgd.h5')